...
func (c *impl) logSQL(sql string) string {
	c.l.Info("SQL", "query", sql)
	return sql
}

func (c *impl) fetchOneItem(entity, id string, retrieve bool) (res Untyped, err error) {
...
func (c *impl) ListItems(entity string, qe query.Interface) ([]Untyped, error) {
	if !*c.config.Read {
...
func (c *impl) ListEntities() ([]string, error) {
	if !*c.config.Read {
		return nil, errReadNotAllowed
	}
	var (
...
func (c *impl) Exists(entity, id string) (bool, error) {
	if !*c.config.Read {
...
func (c *impl) Get(entity, id string) (res Untyped, err error) {
	if !*c.config.Read {
		return nil, errReadNotAllowed
	}
...
func (c *impl) Delete(entity, id string) (err error) {
	if !*c.config.Delete {
...
func (c *impl) Update(entity, id string, body Untyped) (Untyped, error) {
	if !*c.config.Update {
...
func (c *impl) Create(entity string, body Untyped) (Untyped, error) {
	if !*c.config.Create {
